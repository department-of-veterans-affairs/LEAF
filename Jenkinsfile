node {
	...
	checkout([$class: 'GitSCM', branches: [[name: 'leaf']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'build_automation']], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'GlobalJenkinsUser', url: 'https://demo.ablevets.com/coderepo/scm/avss/build_automation.git']]])
    echo "ls -l"
	sh 'ls -l'

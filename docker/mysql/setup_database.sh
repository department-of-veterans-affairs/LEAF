...
INSERT INTO leaf_config.orgchart_configs (id, name, url, database_name, path, launchpad_id, upload_directory, active_directory_path, title, city, adminLogonName,leaf_secure,libs_path) values (1,"Organizational Chart","http://localhost/LEAF_Nexus/","leaf_users","/LEAF_Nexus/",1,"./UPLOADS/",'["OU=Users,DC=va,DC=gov"]',"Organizational Chart","Washington D.C. VAMC","admin",0,'');
INSERT INTO leaf_config.portal_configs (id,name,url,database_name,path,launchpad_id,upload_directory,active_directory_path,leaf_secure,title,city,adminLogonName,libs_path,descriptionID,emailPrefix,emailCC,emailBCC,orgchart_id,orgchart_tags) VALUES (1,"Resources","http://localhost/LEAF_Request_Portal/","leaf_portal","/LEAF_Request_Portal/",0,"./UPLOADS/","[]",0,"Resources","Anytown, USA","admin","",16,"Resources: ","[]","[]",1,'["resources_site_access"]');
INSERT_DATA

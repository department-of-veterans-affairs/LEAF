...
CREATE TABLE IF NOT EXISTS `records_workflow_state` (
  ...
  INDEX idx_lastNotified ON records_workflow_state (lastNotified),
...
(-8, 'Approval Officials', '', NULL, NULL, NULL, 'leaf_devconsole', NULL, NULL, NULL, 0, 2, '2019-12-13 17:09:58', 0, 0),

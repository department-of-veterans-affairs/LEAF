...
mysql -u tester -ptester national_leaf_launchpad < /leaf-boilerplate/dev_national_leaf_launchpad.sql

mysql -u tester -ptester leaf_portal < /leaf-boilerplate/resource_database_boilerplate.sql
mysql -u tester -ptester leaf_portal < /leaf-boilerplate/dev_leaf_portal.sql

mysql -u tester -ptester leaf_users < /leaf-boilerplate/orgchart_boilerplate_empty.sql
mysql -u tester -ptester leaf_users < /leaf-boilerplate/dev_leaf_users.sql

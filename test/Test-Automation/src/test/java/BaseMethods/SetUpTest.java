...
public class SetUpTest {
    ...
    @BeforeMethod
    public void setUp(@Optional("https://host.docker.internal/LEAF_Request_Portal/admin/?a=form_vue#/") String env, @Optional("CHROME") String browser, @Optional("") String remote_url) throws MalformedURLException {

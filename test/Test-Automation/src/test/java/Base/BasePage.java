...
import test.java.Utility.Utility;
...
public class BasePage extends Utility {
    ...
    @Parameters({ "env", "app_url", "browser", "remote_url" })
    @BeforeSuite
    public static void setUp(@Optional("qa") String env,
                      @Optional("") String app_url,
                      @Optional("firefox") String browser,
                      @Optional("") String remote_url) throws MalformedURLException{

        browserInitialization(browser,env, remote_url, app_url);
    ...
    public static void browserInitialization(String browser,String env, String remote_url, String app_url) throws MalformedURLException {
        System.out.println("Browser: "+browser+", env: "+env+", remote_url: "+remote_url+", app_url: "+app_url);

        if(env.equalsIgnoreCase("remote")){
            driver = createDriver(remote_url);
            if (app_url.equals("")) {
            ...
            redirectURL();
            log.info("Fetching App URL : "+ Constants.getEnvURL());
        }

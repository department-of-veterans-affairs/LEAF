package test.java.CurrentMethod;
...
public class _currentMethod extends setupFramework {

	test.java.PageObjectClass.currentMethods_PageActions currentMethods ;
	adminUserAccess_PageObjects adminUserAccess;
	...
	public void setUp()  {
		if(driver!= null) {
			...
			currentMethods = new test.java.PageObjectClass.currentMethods_PageActions(driver);
			adminUserAccess = new adminUserAccess_PageObjects(driver);
...
//        System.out.println("Selected SysAdmin button");
//	} 
//
//
//	
...
//	} 
	...
	public void filterByName2() {
		...
		adminUserAccess.userGroupSearch();
    	...
    	for(int i = 0; i < name.length(); i++) {
    		...
    		//ele.sendKeys(Keys.chord(name));
    		//ele.sendKeys(s);
			adminUserAccess.enterValueOnuserGroupSearch(s);
    		waitMethods.waiter(waitMethods.w30);
    	}
		...
		adminUserAccess.clearuserGroupSearch();
		System.out.println("Filtered by user name (2)");
...
//TODO: Add Assertion
	...
	public void inputAdminCandidate() {
    	...
    	for(int i = 0; i < name.length(); i++) {
    		...
    		//ele.sendKeys(s);
    		//waitMethods.waiter(waitMethods.w30);
			currentMethods.enterInputAdminCandidate(s);
    	}
	}
	...
	private void verifyAddAdministrator() {
		...
		currentMethods.clickAddAdministrator();
		System.out.println("Newly added Administrator found");
...
//PICKUP HERE	
	...
	private void removeAddedAdministrator() {
		...
		currentMethods.clickremoveAddedAdministrator();
		System.out.println("Added Administrator Removed");

...
public class AppVariables {
	...
	public final static String CHROMEDRIVER = "resources/chromedriver.exe";
	...
	public final static String LOCALURI ="http://host.docker.internal/LEAF_Request_Portal/admin/";

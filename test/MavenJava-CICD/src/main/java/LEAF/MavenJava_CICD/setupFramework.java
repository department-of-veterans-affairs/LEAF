...
public class setupFramework {
	...
	private void setDriver(String browser, String env) 	{	// 3		
	...
	private static WebDriver chromeLogin(String env) {				// 4
		//DesiredCapabilities cap = new DesiredCapabilities();
		System.out.println("Launching Chrome by Automation");  //Step Over until - return driver;
		System.setProperty("webdriver.chrome.driver", LEAF.MavenJava_CICD.AppVariables.CHROMEDRIVER);
			...
			WebDriver driver = new ChromeDriver(startOptions);		// for running locally
			
			//cap.setBrowserName("chrome");
			//driver = new RemoteWebDriver(new URL(spec: "https://localhost:4444/wd/hub"), cap);
...
//			}
	...
	private static WebDriver ieLogin(String env) {
		System.setProperty("webdriver.ie.driver", LEAF.MavenJava_CICD.AppVariables.IEDRIVER);

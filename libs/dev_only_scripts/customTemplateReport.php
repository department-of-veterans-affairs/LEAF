                                ...
                                if (is_dir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/templates/reports')) {
                                    ...
                                    foreach($fourth as $four) {
                                        if ($four != '.' && $four != '..' && is_dir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four)) {
                                            if (is_dir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/templates/reports')) {
                                                $events = scandir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/templates/reports');
                                                ...
                                                foreach ($events as $event) {
                                                    if (
                                                        ...
                                                        //echo $dir . '/' . $visn . '/' . $section . '/' . $portal . '/templates/reports' . '/' . $event . '<br />';
                                                        if (is_file($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/templates/reports' . '/' . $event) && substr($event, -4) == '.tpl') {
                                                            $files++;
                                                            cleanFile($visn . '/' . $section . '/' . $portal . '/' . $four . '/templates/reports' . '/' . $event);
                                                            $txt = '2. ' . $dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/templates/reports' . '/' . $event . '<br />';
                                                            //fwrite($myfile, $txt);
                                                            $txt = getLineWithString($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/templates/reports' . '/' . $event);
                                                            //fwrite($myfile, $txt);
                                                        }
                                                    }
                                                }
                                                ...
                                                foreach($fifth as $five) {
                                                    if ($five != '.' && $five != '..' && is_dir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five)) {
                                                        if (is_dir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five . '/templates/reports')) {
                                                            $events = scandir($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five . '/templates/reports');
                                                            ...
                                                            foreach ($events as $event) {
                                                                if (
                                                                    ...
                                                                    //echo $dir . '/' . $visn . '/' . $section . '/' . $portal . '/templates/reports' . '/' . $event . '<br />';
                                                                    if (is_file($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five . '/templates/reports' . '/' . $event) && substr($event, -4) == '.tpl') {
                                                                        $files++;
                                                                        cleanFile($visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five . '/templates/reports' . '/' . $event);
                                                                        $txt = '2. ' . $dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five . '/templates/reports' . '/' . $event . '<br />';
                                                                        //fwrite($myfile, $txt);
                                                                        $txt = getLineWithString($dir . '/' . $visn . '/' . $section . '/' . $portal . '/' . $four . '/' . $five . '/templates/reports' . '/' . $event);
                                                                        //fwrite($myfile, $txt);
                                                                    }
                                                                }
                                                            }

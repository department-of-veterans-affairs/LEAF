var gridInput = function(gridParameters, indicatorID, series, recordID) {
    ...
    function printTableInput(values){
        ...
        for(var i = 0; i < rows; i++){
            ...
            if(rows === 1) {
                $(gridBodyElement + ' > tr:eq(' + i + ')').append('<td><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.deleteRow(event)" src="' + libsPath + 'dynicons/?img=process-stop.svg&w=16" title="Delete line" alt="Delete line" style="cursor: pointer" /></td><td><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.moveUp(event)" src="' + libsPath + 'dynicons/?img=go-up.svg&w=16" title="Move line up" alt="Move line up" style="display: none; cursor: pointer" /></br></br><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.moveDown(event)" src="' + libsPath + 'dynicons/?img=go-down.svg&w=16" title="Move line down" alt="Move line down" style="display: none; cursor: pointer" /></td>');
            } else {
                switch (i) {
                    case 0:
    ...
    function addRow(){
        ...
        if($(gridBodyElement).children().length === 1){
            $(gridBodyElement + ' > tr:last').append('<td><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.deleteRow(event)" src="' + libsPath + 'dynicons/?img=process-stop.svg&w=16" title="Delete line" alt="Delete line" style="cursor: pointer" /></td><td><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.moveUp(event)" src="' + libsPath + 'dynicons/?img=go-up.svg&w=16" title="Move line up" alt="Move line up" style="cursor: pointer; display: none;" /></br></br><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.moveDown(event)" style="display: none" src="' + libsPath + 'dynicons/?img=go-down.svg&w=16" title="Move line down" alt="Move line down" style="cursor: pointer" /></td>');
        } else {
            $(gridBodyElement + ' > tr:last').append('<td><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.deleteRow(event)" src="' + libsPath + 'dynicons/?img=process-stop.svg&w=16" title="Delete line" alt="Delete line" style="cursor: pointer" /></td><td><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.moveUp(event)" src="' + libsPath + 'dynicons/?img=go-up.svg&w=16" title="Move line up" alt="Move line up" style="cursor: pointer" /></br></br><img role="button" tabindex="0" onkeydown="gridInput_' + indicatorID + '_' + series + '.triggerClick(event);" onclick="gridInput_' + indicatorID + '_' + series + '.moveDown(event)" style="display: none" src="' + libsPath + 'dynicons/?img=go-down.svg&w=16" title="Move line down" alt="Move line down" style="cursor: pointer" /></td>');
        }

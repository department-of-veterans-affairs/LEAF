...
var LeafFormSearch = function(containerID) {
	...
	function renderWidget(widgetID, callback) {
		switch($('#' + prefixID + 'widgetTerm_' + widgetID).val()) {
			case 'title':
				$('#' + prefixID + 'widgetCondition_' + widgetID).html('<select id="'+prefixID+'widgetCod_'+widgetID+'" class="chosen"  aria-label="ChosenForm" style="width: 120px">\
			...
			case 'serviceID':
				...
				$.ajax({
					...
					success: function(res) {
						var services = '<select id="'+prefixID+'widgetMat_'+widgetID+'" class="chosen" aria-label="ChosenForm" style="width: 250px">';
						for(var i in res) {
				...
				break;
			case 'date':
				$('#' + prefixID + 'widgetCondition_' + widgetID).html('<select id="'+prefixID+'widgetCod_'+widgetID+'" style="width: 140px" class="chosen" aria-label="ChosenForm">\
			...
			case 'categoryID':
				...
				$.ajax({
					...
					dataType: 'json',
					success: function(res) {
						var categories = '<select id="'+prefixID+'widgetMat_'+widgetID+'" class="chosen" aria-label="ChosenForm" style="width: 250px">';
						for(var i in res) {
			...
			case 'dependencyID':
				...
				$.ajax({
					...
					dataType: 'json',
					success: function(res) {
						var dependencies = '<select id="'+prefixID+'widgetIndicator_'+widgetID+'" class="chosen" aria-label="ChosenForm" style="width: 250px">';
						for(var i in res) {
						...
						var options = '<select id="'+prefixID+'widgetMat_'+widgetID+'" class="chosen" aria-label="ChosenForm" style="width: 250px">';
			...
			case 'data':
				$.ajax({
					...
					dataType: 'json',
					success: function(res) {
						var indicators = '<select id="'+prefixID+'widgetIndicator_'+widgetID+'" class="chosen" aria-label="ChosenForm" style="width: 250px">';
							...
							for(var i in res) {
								if(res[i].indicatorID == iID) {
									...
									switch(format) {
										case 'number':
										case 'currency':
											$('#' + prefixID + 'widgetCondition_' + widgetID).html('<select id="'+prefixID+'widgetCod_'+widgetID+'" class="chosen" aria-label="ChosenForm" style="width: 55px">\
								            		<option value="=">=</option>\
								            		<option value=">">></option>\
								            		<option value=">=">>=</option>\
								            		<option value="<"><</option>\
	...
	function newSearchWidget() {
		var widget = '<tr id="'+prefixID+'widget_'+widgetCounter+'">\
						...
						<td><select id="'+prefixID+'widgetTerm_'+widgetCounter+'" style="width: 150px" class="chosen" aria-label="ChosenForm">\

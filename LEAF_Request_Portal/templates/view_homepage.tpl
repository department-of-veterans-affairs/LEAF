...
<a href="?a=newform" role="button">
    <span class="menuButtonSmall" style="background-color: #2372b0; color: white">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=document-new.svg&amp;w=76" style="position: relative" alt=""/>
...
<a href="?a=inbox" role="button">
    <span class="menuButtonSmall" style="background-color: #c9c9c9">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=folder-open.svg&amp;w=76" style="position: relative" alt=""/>
...
<a href="?a=inbox" role="button">
    <span class="menuButtonSmall" style="background-color: #b6ef6d">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=document-open.svg&amp;w=76" style="position: relative" alt=""/>
        <span class="menuTextSmall">Inbox</span><br />
...
<a href="?a=bookmarks" role="button">
    <span class="menuButtonSmall" style="background-color: #7eb2b3">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=bookmark.svg&amp;w=76" style="position: relative" alt=""/>
...
<a href="?a=reports&v=3" role="button">
    <span class="menuButtonSmall" style="background-color: black">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=x-office-spreadsheet.svg&amp;w=76" style="position: relative" alt=""/>

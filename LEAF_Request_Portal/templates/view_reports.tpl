...
function loadSearchPrereqs() {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            buffer += '<input type="checkbox" class="icheck" id="indicators_title" name="indicators[title]" value="title" /><span class="leaf_check"></span> Title of Request</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_service">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_service" name="indicators[service]" value="service" /><span class="leaf_check"></span> Service</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_type">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_type" name="indicators[type]" value="type" /><span class="leaf_check"></span> Type of Request</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_status">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_status" name="indicators[status]" value="status" /><span class="leaf_check"></span> Current Status</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_initiator">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_initiator" name="indicators[initiator]" value="initiator" /><span class="leaf_check"></span> Initiator</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_actionButton">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_actionButton" name="indicators[actionButton]" value="actionButton" /><span class="leaf_check"></span> Action Button</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_action_history">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_action_history" name="indicators[action_history]" value="action_history" /><span class="leaf_check"></span> Comment History</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_approval_history">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_approval_history" name="indicators[approval_history]" value="approval_history" /><span class="leaf_check"></span> Approval History</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_days_since_last_action">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_days_since_last_action" name="indicators[days_since_last_action]" value="days_since_last_action" /><span class="leaf_check"></span> Days Since Last Action</label></div>';
            buffer += '<div class="indicatorOption"><label class="checkable" for="indicators_days_since_last_step_movement">';
            buffer += '<input type="checkbox" class="icheck" id="indicators_days_since_last_step_movement" name="indicators[days_since_last_step_movement]" value="days_since_last_step_movement" /><span class="leaf_check"></span> Days Since Last Step Movement</label></div>';
            buffer += '</div>';
            ...
            for(let k in groupNames) {
                ...
                for(let j in groupList[i]) {
                    ...
                    buffer += `<input type="checkbox" class="icheck parent" id="indicators_${indID}" name="indicators[${indID}]" value="${indID}" />`
                    ...
                    if (format && format.indexOf('grid')===0) {
                        ...
                        for (let c in cols) {
                            ...
                            buffer += `<input type="checkbox" class="icheck parent-indicators_${indID}" id="indicators_${indID}_columns_${col.id}" name="indicators[${indID}].columns[${col.name}]" value="${col.id}" gridParent="${indID}" />`;
            ...
            $.ajax({
            	...
            	success: function(res) {
                    ...
                    for(let i in res) {
                        ...
                        buffer += '<input type="checkbox" class="icheck" id="indicators_stepID_'+ res[i].stepID +'" name="indicators[stepID'+ res[i].stepID +']" value="stepID_'+ res[i].stepID +'" />'
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            buffer2 += '<input type="checkbox" class="icheck" id="indicators_dateCancelled" name="indicators[dateCancelled]" value="dateCancelled" /><span class="leaf_check"></span> Date Request Cancelled</label></div>';
                            buffer2 += '<div class="indicatorOption"><label class="checkable" for="indicators_dateInitiated" title="Date request initiated">';
                            buffer2 += '<input type="checkbox" class="icheck" id="indicators_dateInitiated" name="indicators[dateInitiated]" value="dateInitiated" /><span class="leaf_check"></span> Date Request Initiated</label></div>';
                            buffer2 += '<div class="indicatorOption"><label class="checkable" for="indicators_dateResolved" title="Date request resolved">';
                            buffer2 += '<input type="checkbox" class="icheck" id="indicators_dateResolved" name="indicators[dateResolved]" value="dateResolved" /><span class="leaf_check"></span> Date Request Resolved</label></div>';
                            buffer2 += '<div class="indicatorOption"><label class="checkable" for="indicators_resolvedBy" title="Resolved By">';
                            buffer2 += '<input type="checkbox" class="icheck" id="indicators_resolvedBy" name="indicators[resolvedBy]" value="resolvedBy" /><span class="leaf_check"></span> Resolved By</label></div>';

                            for(let i in res) {
                                buffer2 += '<div class="indicatorOption"><label class="checkable" for="indicators_depID_'+ res[i].dependencyID +'">';
                                buffer2 += '<input type="checkbox" class="icheck" id="indicators_depID_'+ res[i].dependencyID +'" name="indicators[depID_'+ res[i].dependencyID +']" value="depID_'+ res[i].dependencyID +'" /><span class="leaf_check"></span> ' + res[i].description +'</label></div>';
                            }
                            buffer2 += '</div>';

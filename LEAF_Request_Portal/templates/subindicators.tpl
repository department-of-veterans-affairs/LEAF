    ...
    <!--{foreach from=$form item=indicator}-->
        ...
        <div class="mainlabel">
            <div>
            <span>
                <b><!--{$indicator.name|sanitize}--></b><!--{if $indicator.required == 1}--><span id="<!--{$indicator.indicatorID|strip_tags}-->_required" style="margin-left: 8px; color: red;">*&nbsp;Required</span><!--{/if}--><br />
            </span>
            </div>
                <!--{else}-->
        <div class="sublabel blockIndicator_<!--{$indicator.indicatorID|strip_tags}-->">
            <span>
                    <!--{if $indicator.format == null}-->
                        <br /><b><!--{$indicator.name|sanitize|indent:$depth:""}--></b><!--{if $indicator.required == 1}--><span id="<!--{$indicator.indicatorID|strip_tags}-->_required" style="margin-left: 8px; color: red;">*&nbsp;Required</span><!--{/if}-->
                    <!--{else}-->
                        <br /><!--{$indicator.name|sanitize|indent:$depth:""}--><!--{if $indicator.required == 1}--><span id="<!--{$indicator.indicatorID|strip_tags}-->_required" style="margin-left: 8px; color: red;">*&nbsp;Required</span><!--{/if}-->
                    <!--{/if}-->
            </span>
                <!--{/if}-->
        </div>

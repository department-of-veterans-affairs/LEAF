{if $action != ''}
    <a href="./" class="buttonNorm" title="nav to homepage"><img src="{$lib_path}dynicons/?img=go-home.svg&amp;w=16" alt="" />Main Page</a>
{/if}
...
<div id="headerMenuHelp_container" style="display: inline-block">
    <a id="button_showHelp" tabIndex="0" class="buttonNorm" title="primary admin contact information" aria-haspopup="true" aria-expanded="false" role="button">
        <img style="vertical-align: sub;" src="{$lib_path}dynicons/?img=help-browser.svg&amp;w=16" alt="" />&nbsp;Help
    </a>
...
{if $is_admin == true}
     <a href="./admin/" class="buttonNorm" role="button"><img src="{$lib_path}dynicons/?img=applications-system.svg&amp;w=16" alt=""/>Admin Panel</a>
{/if}

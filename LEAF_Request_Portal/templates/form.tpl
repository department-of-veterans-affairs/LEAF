<div class="section group">
    ...
    <div class="col span_3_of_5">
        <div style="background-color: white; border: 1px solid black; box-shadow: 0 2px 4px #8e8e8e">
            <div id="progressArea" style="height: 34px; background-color: #feffd2; padding: 4px; border-bottom: 1px solid black">
                ...
                <div style="float: right"><button id="nextQuestion" type="button" class="buttonNorm nextQuestion"><img src="<!--{$libsPath}-->dynicons/?img=go-next.svg&amp;w=22" alt="Next" /> Next Question</button></div>
                <br style="clear: both" />
            </div>
            <div>
            ...
            <div id="progressArea2" style="height: 34px; background-color: #feffd2; padding: 4px; border-top: 1px solid black">
                <div style="float: left"><button id="prevQuestion" type="button" class="buttonNorm prevQuestion"><img src="<!--{$libsPath}-->dynicons/?img=go-previous.svg&amp;w=22" alt="Previous" aria-label="Previous"/> Previous Question</button></div>
                <div style="float: right"><button id="nextQuestion2" type="button" class="buttonNorm nextQuestion"><img src="<!--{$libsPath}-->dynicons/?img=go-next.svg&amp;w=22" alt="Next" aria-label="Next"/> Next Question</button></div>
            </div>
        </div>
        <br />
    ...
    <div class="col span_1_of_5" style="float: left">
        <div id="tools" class="tools"><h1 style="font-size: 12px; text-align: center; margin: 0; padding: 2px">Tools</h1>
            <div id="showSinglePage" role="button" onclick="window.location='?a=printview&amp;recordID=<!--{$recordID}-->'" title="View full form"><img src="<!--{$libsPath}-->dynicons/?img=edit-find-replace.svg&amp;w=32" alt="View full form"  /> Show single page</div>
            <br /><br />
            <button tabindex="0" class="tools" aria-label="Cancel request" onclick="cancelRequest()"><img src="<!--{$libsPath}-->dynicons/?img=process-stop.svg&amp;w=16" alt="Cancel Request" title="Cancel Request" style="vertical-align: middle"/> Cancel Request</button>
        </div>
    </div>
</div>
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response < 100) {
                ...
                savechange = '<div tabindex="0" class="buttonNorm" onkeypress="if(event.keyCode === 13){ manualSaveChange(); }" onclick="manualSaveChange();"><div id="save_indicator"><img src="<!--{$libsPath}-->dynicons/?img=media-floppy.svg&amp;w=22" alt="save" style="vertical-align: middle" /> Save Change</div></button>';

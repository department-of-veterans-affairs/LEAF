...
<div style="padding: 8px; margin: auto" id="submitControl">
    <button class="buttonNorm" type="button" style="font-weight: bold; font-size: 120%" title="Submit Form"><img src="{$libsPath}dynicons/?img=go-next.svg&amp;w=32" alt="Submit" />Send Request to Selected Individuals</button>
</div>
<div id="pp_progressSidebar" style="display: none;">
        <div style="padding: 8px; margin: 0px; color: black; font-weight: bold; text-align: center; font-size: 120%"><img src="{$absPortPath}/images/indicator.gif" />Submitting</div>

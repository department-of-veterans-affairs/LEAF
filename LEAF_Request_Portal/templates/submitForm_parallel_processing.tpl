...
<div style="padding: 8px; margin: auto" id="submitControl">
    <button class="buttonNorm" type="button" style="font-weight: bold; font-size: 120%" title="Submit Form"><img src="{$lib_path}dynicons/?img=go-next.svg&amp;w=32" alt="Submit" />Send Request to Selected Individuals</button>
</div>

...
<div class="printmainform" style="border-bottom: 0px; min-height: 64px">
    ...
    <!--{if $submitted == 0 || $is_admin}-->
        <img src="../libs/dynicons/?img=accessories-text-editor.svg&amp;w=16" style="cursor: pointer" alt="Edit Title" title="Edit Title" onclick="changeTitle()" tabindex="0" role="button" />
    <!--{/if}-->
        ...
        <table>
            <tr>
                ...
                <td><b><!--{$service|sanitize}--></b>
                    <!--{if $submitted == 0}-->
                        <img src="../libs/dynicons/?img=accessories-text-editor.svg&amp;w=16" style="cursor: pointer" alt="Edit Service" title="Edit Service" onclick="changeService()" role="button" tabindex="0"/>
                    <!--{/if}-->
                </td>
            </tr>
            <tr>

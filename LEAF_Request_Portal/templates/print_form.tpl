...
function printForm() {
    ...
    function makePdf(data) {
        ...
        function makeEntry(indicator, parentIndex, depth, numAtLevel, index) {
            ...
            function textHeader() {
                verticalShift += -4;
                var headerSplit = doc.splitTextToSize(title, 40);
                ...
                if (!blank || submitted) {
                    ...
                    if (!submitted) {
                        ...
                        if (actionCompleted && requestInfo['lastAction']['action'] !== 'Submitted') {
                            ...
                            verticalShift += 7;
                            doc.text(requestInfo['lastAction']['description'] + ' ' + requestInfo['lastAction']['action'] + ' by ' + requestInfo['lastAction']['userID'] + ' ' + getDate(actionTime), 200, verticalShift, null, null, 'right');
                        }
                    }

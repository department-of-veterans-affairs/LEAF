...
<img src="<!--{$libsPath}-->dynicons/?img=folder-open.svg&amp;w=96" alt="empty" style="float: left; padding-right: 16px"/><div style="font-size: 200%"> Your inbox is empty.<br /><br />Have a good day!</div>
</div>
<!--{/if}-->
...
<br /><br />
<div style="width: 50%; margin: 0px auto; border: 1px solid black; padding: 16px; background-color: white">
<img src="<!--{$libsPath}-->dynicons/?img=folder-open.svg&amp;w=96" alt="empty" style="float: left; padding-right: 16px"/><div style="font-size: 200%">Warning: Inbox limit is in place to ensure consistent performance</div>
</div>
<!--{/if}-->
...
<script type="text/javascript" src="<!--{$libsPath}-->js/LEAF/inbox/view_inbox.js"></script>
<script>

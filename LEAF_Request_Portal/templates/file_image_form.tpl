<form id="record" enctype="multipart/form-data" action="ajaxIndex.php?a=doupload&amp;recordID={$recordID|strip_tags}" method="post">
    ...
    <div id="file{$indicatorID|strip_tags}_control">Select File to attach: <input id="file{$indicatorID|strip_tags}" name="{$indicatorID|strip_tags}" type="file" accept="image/*" /></div>

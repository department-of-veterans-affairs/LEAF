CREATE TABLE `events` (`eventID` VARCHAR(20) NOT NULL, `eventDescription` VARCHAR(64) NOT NULL, `event` INT(64) NOT NULL) ENGINE = InnoDB;
...
CREATE TABLE `route_events` (`workflowID` TINYINT UNSIGNED NOT NULL, `stepID` TINYINT UNSIGNED NOT NULL, `eventID` VARCHAR(20) NOT NULL) ENGINE = InnoDB;

    ...
    <div class="section group">
        ...
        <aside class="sidenav-right">
            ...
            <div id="controls">
                ...
                <button class="usa-button leaf-side-btn leaf-btn-med leaf-width-11rem" onclick="save();">
                    Save Changes<span id="saveStatus" class="leaf-display-block leaf-font-normal leaf-font0-5rem"></span>
                </button>
                
                <button class="usa-button usa-button--secondary leaf-marginTop-1rem leaf-side-btn leaf-btn-med leaf-width-11rem" onclick="restore();">
                    Restore Original
                </button>
                
                <button class="usa-button usa-button--secondary leaf-marginTop-1rem leaf-side-btn leaf-btn-med leaf-width-11rem" id="btn_compareStop" style="display: none" onclick="loadContent();">
                    Stop Comparing
                </button>
                
                <button class="usa-button usa-button--outline leaf-marginTop-1rem leaf-side-btn leaf-btn-med leaf-width-11rem" id="btn_compare" onclick="compare();">
                    Compare to Original
                </button>
                
                <button class="usa-button usa-button--outline leaf-marginTop-1rem leaf-side-btn leaf-btn-med leaf-width-11rem" target="_blank">

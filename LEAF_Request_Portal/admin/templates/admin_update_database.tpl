        ...
        <div id="editdialog1" style="visibility: hidden">
            <div>
                <div id="editxhr" style="width: 500px; height: 400px; overflow: auto">
                    ...
                    <div style="border-bottom: 2px solid black; text-align: right"><br />&nbsp;<!--<button id="button_save"><img src="../dynicons/?img=list-add.svg&amp;w=16" alt="save" /> Add user</button>--></div><br />

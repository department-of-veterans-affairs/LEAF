    ...
    <!--{foreach from=$form item=indicator}-->
      ...
      <div class="printmainblock">
        <div class="printmainlabel">
            ...
            <span onkeydown="onKeyPressClick(event)" class="buttonNorm" tabindex="0" onclick="newQuestion(<!--{$indicator.indicatorID}-->);"><img src="<!--{$lib_path}-->dynicons/?img=list-add.svg&amp;w=16" alt="Add Sub-question" title="Add Sub-question"/> Add Sub-question</span>

            </div>
            <span class="printsubHeading" style="cursor: pointer" title="indicatorID: <!--{$indicator.indicatorID}-->" >
            <!--{if $indicator.is_sensitive == 1}-->
                &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=eye_invisible.svg&amp;w=16" alt="This field is sensitive" title="This field is sensitive" />&nbsp;
            <!--{/if}-->
            ...
            &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=accessories-text-editor.svg&amp;w=16" tabindex="0" onkeypress="keyPressGetForm(event, <!--{$indicator.indicatorID}-->, <!--{$indicator.series}-->)" onclick="getForm(<!--{$indicator.indicatorID}-->, <!--{$indicator.series}-->)" alt="Edit this field" title="Edit this field" style="cursor: pointer" />
            &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=emblem-readonly.svg&amp;w=16" tabindex="0" onkeypress="keyPressEditIndicatorPrivileges(event, <!--{$indicator.indicatorID}-->)" onclick="editIndicatorPrivileges(<!--{$indicator.indicatorID}-->);" alt="Edit indicator privileges" title="Edit indicator privileges" style="cursor: pointer" />
            <!--{if $indicator.has_code}-->
                &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=document-properties.svg&amp;w=16" tabindex="0" alt="Advanced Options present" title="Advanced Options present" style="cursor: pointer" />
            <!--{/if}-->
            </span>
        <!--{else}-->
        ...
        <div class="printsublabel">
            ...
            <!--{/if}-->
                <span class="printsubHeading" style="cursor: pointer" title="indicatorID: <!--{$indicator.indicatorID}-->">
                    ...
                    &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=accessories-text-editor.svg&amp;w=16" tabindex="0" onkeypress="keyPressGetForm(event, <!--{$indicator.indicatorID}-->, <!--{$indicator.series}-->)" onclick="getForm(<!--{$indicator.indicatorID}-->, <!--{$indicator.series}-->)" alt="Edit this field" title="Edit this field" style="cursor: pointer" />
                    &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=emblem-readonly.svg&amp;w=16" tabindex="0" onkeypress="keyPressEditIndicatorPrivileges(event, <!--{$indicator.indicatorID}-->)" onclick="editIndicatorPrivileges(<!--{$indicator.indicatorID}-->);" alt="Edit indicator privileges" title="Edit indicator privileges" style="cursor: pointer" />
                    <!--{if $indicator.format == 'dropdown' || $indicator.format == 'text' || $indicator.format == 'multiselect'}-->
                        &nbsp;<img id="edit_conditions_<!--{$indicator.indicatorID}-->" src="<!--{$lib_path}-->dynicons/?img=preferences-system.svg&amp;w=16" tabindex="0" onkeypress="updateVueData(<!--{$indicator.indicatorID}-->)" onclick="updateVueData(<!--{$indicator.indicatorID}-->,<!--{$indicator.required}-->);" alt="Edit Conditions" title="Edit conditions" style="cursor: pointer" />
                    <!--{/if}-->
                    <!--{if $indicator.has_code}-->
                        &nbsp;<img src="<!--{$lib_path}-->dynicons/?img=document-properties.svg&amp;w=16" tabindex="0" alt="Advanced Options present" title="Advanced Options present" style="cursor: pointer" />
                    <!--{/if}-->
                <br /><br /><span tabindex="0" class="buttonNorm" onkeypress="onKeyPressClick(event)" onclick="newQuestion(<!--{$indicator.indicatorID}-->);"><img src="<!--{$lib_path}-->dynicons/?img=list-add.svg&amp;w=16" alt="Add Sub-question" title="Add Sub-question"/> Add Sub-question</span>
                </span>
        <!--{/if}-->
            </div>

    ...
    <!--{foreach from=$form item=indicator}-->
      ...
      <div class="printmainblock">
        <div class="printmainlabel">
            ...
            &nbsp;<img <!--{if $indicator.has_code}-->style="border: 1px solid #e00000; margin: -1px 0 -1px 0;"<!--{/if}--> src="../../libs/dynicons/?img=accessories-text-editor.svg&amp;w=16" tabindex="0" onkeypress="keyPressGetForm(event, <!--{$indicator.indicatorID}-->, <!--{$indicator.series}-->)" onclick="getForm(<!--{$indicator.indicatorID}-->, <!--{$indicator.series}-->)" alt="Edit this field" title="Edit this field" style="cursor: pointer" />&nbsp;

<a id=menuLink href="../{$orgchartPath}" target="_blank">
    <span id=menuButton class="menuButtonSmall" style="background-color: #ffecb7">
...
<script>
    $('#menuLink').focusin(function() {
        $('#menuButton').css('box-shadow', '0 4px 6px 2px #8e8e8e').css('margin', '12px').css('outline', 'black dotted');
    }).focusout(function() {
        $('#menuButton').css('box-shadow', '0 0 0 0').css('margin', '0px').css('outline', 'none');
    });
</script>
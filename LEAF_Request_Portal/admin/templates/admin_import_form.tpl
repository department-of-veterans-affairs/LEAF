<div class="leaf-center-content">
    <form id="record" enctype="multipart/form-data" action="ajaxIndex.php?a=manualImportForm" method="post">
        ...
        <div id="file_status" style="visibility: hidden; display: none; background-color: #fffcae; padding: 4px"><img src="<!--{$absPortPath}-->/images/indicator.gif" alt="loading..." /> Importing form...</div>
    </form>
</div>

<ul>
    ...
    <li id="toggleMenu" role="button" aria-haspopup="true">
        <a href="javascript:void(0);"><span aria-hidden="true" class="leaf-menu"><button title="Toggle Navigation">MENU</button></span><i aria-hidden="true" class="fas fa-times"></i></a>
    </li>

...
<a href="?a=mod_groups" tabindex="-1">
...
<a href="?a=mod_svcChief" tabindex="-1">
...
<a href="?a=mod_file_manager" tabindex="-1">
    <span class="menuButton" style="background-color: black" tabindex="0">

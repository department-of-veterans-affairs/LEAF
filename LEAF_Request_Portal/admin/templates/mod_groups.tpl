                                ...
                                if (Array.isArray(res)) {
                                    ...
                                    for(let i in res) {
                                        if (res[i].backupID == '') {
                                            ...
                                            let addToNexus = `${res[i].locallyManaged != 0 ? `<button id="addNexusMember_${counter}" class="usa-button leaf-btn-small leaf-font0-8rem" style="font-size: 0.8em; display: inline-block; margin: auto; min-width: 4rem;" title="Add this user to Nexus group">Add to Nexus</button>` : ''}`;
                                            let removeButton = `<td style="font-size: 0.8em; text-align: center;">${addToNexus}<button id="removeMember_${counter}" class="usa-button usa-button--secondary leaf-btn-small leaf-font0-8rem" style="font-size: 0.8em; display: inline-block; min-width: 4rem;" title="Remove this user from this group">Remove</button>`;

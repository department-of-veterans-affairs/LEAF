                                ...
                                if (Array.isArray(res)) {
                                    ...
                                    for(let i in res) {
                                        if (res[i].backupID == '') {
                                            ...
                                            let isInherited = `<td style="font-size: 0.8em; text-align: center;">${res[i].locallyManaged == 0 ? '<span style="color: green; font-size: 1.2rem; margin: 1rem;">&#10004;</span>' : `<button id="addNexusMember_${counter}" class="usa-button leaf-btn-small leaf-font0-8rem" style="font-size: 0.8em; display: inline-block; margin: auto; min-width: 4rem;" title="Add this user to Nexus group">Add to Nexus</button>`}</td>`;
                                            let removeButton = `<td style="font-size: 0.8em; text-align: center;"><button id="removeMember_${counter}" class="usa-button usa-button--secondary leaf-btn-small leaf-font0-8rem" style="font-size: 0.8em; display: inline-block; min-width: 4rem;" title="Remove this user from this group">Remove</button>`;

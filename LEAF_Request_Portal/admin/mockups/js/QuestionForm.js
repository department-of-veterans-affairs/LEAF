	...
	template:
		`<div class="card question">\
			<div style="float:right;">
				<input type="checkbox" id="options-required" name="options-required" v-model="required" true-value="true" false-value="false">
			...
			<label for="input-text-question-text">Question Text <a href="#" style="padding-left:1rem">Advanced Formatting</a></label>\
			<input id="input-text-question-text"\
				name="input-text-question-text"
				type="text"
				v-model.trim="text">\
			...
			<div v-show="type === 'radio' || type === 'checkbox' || type === 'checkboxes' || type === 'dropdown'">
				<label>One option per line:</label>
				<textarea id="textarea-multi-input" v-model="multiInputOptions" style="max-width:100%;min-width:100%;"></textarea>
			</div>
			
			<label for="textarea-question-default-answer">Default Answer</label>
			<textarea v-model="answer" name="textarea-question-default-answer" style="max-width:100%;min-width:100%;"></textarea>

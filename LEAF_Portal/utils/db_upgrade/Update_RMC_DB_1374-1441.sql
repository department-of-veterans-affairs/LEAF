...
CREATE TABLE `workflows` (`workflowID` TINYINT NOT NULL, `description` VARCHAR(64) NOT NULL, PRIMARY KEY (`workflowID`)) ENGINE = InnoDB;
...
CREATE TABLE `dependency_privs` (`dependencyID` TINYINT UNSIGNED NOT NULL, `groupID` TINYINT UNSIGNED NOT NULL) ENGINE = InnoDB;
...
CREATE TABLE `workflow_steps` (`workflowID` TINYINT NOT NULL, `stepID` TINYINT NOT NULL, `actions` VARCHAR(128) NOT NULL, `route` TEXT NOT NULL, PRIMARY KEY (`stepID`)) ENGINE = InnoDB;
...
CREATE TABLE `step_dependencies` (`stepID` TINYINT NOT NULL, `dependencyID` TINYINT NOT NULL) ENGINE = InnoDB;
...
CREATE TABLE `actions` (`actionType` VARCHAR(20) NOT NULL, `actionText` VARCHAR(20) NOT NULL, `actionIcon` VARCHAR(50) NOT NULL, `actionAlignment` VARCHAR(10) NOT NULL, PRIMARY KEY (`actionType`)) ENGINE = InnoDB;
...
CREATE TABLE `records_workflow_state` (`recordID` SMALLINT NOT NULL, `stepID` TINYINT NOT NULL) ENGINE = InnoDB;
...
CREATE TABLE `step_actions` (`stepID` TINYINT UNSIGNED NOT NULL, `actionType` VARCHAR(20) NOT NULL) ENGINE = InnoDB;
...
CREATE TABLE `workflow_routes` (`workflowID` TINYINT UNSIGNED NOT NULL, `stepID` TINYINT UNSIGNED NOT NULL, `nextStepID` TINYINT UNSIGNED NOT NULL, `actionType` VARCHAR(20) NOT NULL, `fillDependency` TINYINT NOT NULL) ENGINE = InnoDB;

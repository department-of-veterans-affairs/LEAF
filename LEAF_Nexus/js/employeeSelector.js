...
employeeSelector.prototype.initialize = function() {
	...
	$('#' + this.containerID).html('<div id="'+this.prefixID+'border" class="employeeSelectorBorder">\
			<div style="float: left"><img id="'+this.prefixID+'icon" src="'+ t.libsPath +'dynicons/?img=search.svg&w=16" class="employeeSelectorIcon" alt="search" />\
			<img id="'+this.prefixID+'iconBusy" src="'+ t.absRootPath +'images/indicator.gif" style="display: none" class="employeeSelectorIcon" alt="busy" /></div>\
			...
			<input id="'+this.prefixID+'input" type="search" class="employeeSelectorInput test" aria-label="search input"/></div>\

    ...
    var ajaxOptions = {
        ...
        success: function(response) {
            ...
            if(t.outputStyle == 'micro') {
                buffer = '<table aria-live="true" aria-atomic="true" tabindex="0" class="employeeSelectorTable usa-table"><thead><tr><th>Name</th><th>Contact</th></tr></thead><tbody id="' + t.prefixID + 'result_table"></tbody></table>';
            }
            else {
                buffer = '<table aria-live="true" aria-atomic="true" tabindex="0" class="employeeSelectorTable usa-table"><thead><tr><th>Name</th><th>Location</th><th>Contact</th></tr></thead><tbody id="' + t.prefixID + 'result_table"></tbody></table>';
            }

            $('#' + t.prefixID + 'result').html(buffer);

            if(response.length == 0) {
                $('#' + t.prefixID + 'result_table').append('<tr id="' + t.prefixID + 'emp0"><td style="text-align: center" colspan=3>No results for &quot;<span style="color: red">'+ txt +'</span>&quot;</td></tr>');

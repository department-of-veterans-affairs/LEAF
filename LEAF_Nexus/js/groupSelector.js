...
groupSelector.prototype.initialize = function () {
    ...
    $("#" + this.containerID).html(
        '<div id="' +
            ...
            'icon" src="' +
            this.basePath +
            '../libs/dynicons/?img=search.svg&w=16" class="groupSelectorIcon" alt="search" />\
            ...
            'iconBusy" src="' +
            this.basePath +
            'images/indicator.gif" style="display: none" class="groupSelectorIcon" alt="search" /></div>\
			<input id="' +
            this.prefixID +
            'input" type="search" class="groupSelectorInput" aria-label="search"></input></div>\
			<div id="' +
            this.prefixID +
            'result"></div>'
    );

...
<div id="editdialog1" style="visibility: hidden">
    <div>
        <div id="editxhr" style="width: 500px; height: 400px; overflow: auto">
            ...
            <span>Search: </span><input id="query" type="text" /><div id="loadIndicator" style="visibility: hidden; float: right"><img src="<!--{$absOrgPath}-->/images/indicator.gif" alt="loading..." /></div>

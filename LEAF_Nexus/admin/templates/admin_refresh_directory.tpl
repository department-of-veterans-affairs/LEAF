...
<div style="width: 99%;margin: 12px">
    <div id="info_refresh_container">
        <img id="info_refresh_icon" src="<!--{$lib_path}-->dynicons/?img=emblem-notice.svg&w=64" style="float:left;margin-right: 12px"/>
...
$(function() {
    $.ajax({
        ...
        error: function(response) {
            $('#info_refresh_icon').attr('src', <!--{$lib_path}-->dynicons/?img=process-stop.svg&w=64');

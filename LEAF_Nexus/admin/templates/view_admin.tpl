...
<a href="../?a=browse_group" tabindex="-1">
    <span class="menuButton" style="background-color: #cb9ed7" tabindex="0">
        <img class="menuIcon" src="<!--{$lib_path}-->dynicons/?img=preferences-desktop-theme.svg&amp;w=96" style="position: relative" alt="Group Search" title="Group Search" />
...
<a href="?a=admin_refresh_directory" tabindex="-1">
    <span class="menuButton" style="background-color: #ffefa5" tabindex="0">
        <img class="menuIcon" src="<!--{$lib_path}-->dynicons/?img=system-software-update.svg&amp;w=96" style="position: relative" alt="Directory Update" title="Directory Update" />
...
<a href="?a=setup_medical_center" tabindex="-1">
    <span class="menuButton" style="background-color: #c6ffbe" tabindex="0">
        <img class="menuIcon" src="<!--{$lib_path}-->dynicons/?img=preferences-system.svg&amp;w=96" style="position: relative" alt="Bookmarks" title="Bookmarks" />
...
<a href="?a=mod_templates_reports" tabindex="-1">
    <span class="menuButton" style="background-color: black" tabindex="0">
        <img class="menuIcon" src="<!--{$lib_path}-->dynicons/?img=utilities-terminal.svg&amp;w=76" style="position: relative" alt="Bookmarks" title="Bookmarks" />
...
<a href="../?a=browse_search" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: #414141" tabindex="0">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=system-search.svg&amp;w=72" style="position: relative" alt="Search" title="Search" />
...
<a href="#" onclick="newEmployee()" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: #414141" tabindex="0">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=list-add.svg&amp;w=72" style="position: relative" alt="Search" title="Search" />
...
<a href="?a=import_employees_from_spreadsheet" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: black" tabindex="0">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=list-add.svg&amp;w=72" style="position: relative" alt="Bookmarks" title="Bookmarks" />
...
<a href="?a=mod_system" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: black" tabindex="0">
        <img class="menuIconSmall" src="<!--{$lib_path}-->dynicons/?img=preferences-desktop.svg&amp;w=72" style="position: relative" alt="Bookmarks" title="Bookmarks" />
...
<a href="?a=admin_update_database" tabindex="-1">
    <span class="menuButton" style="background-color: #ffefa5" tabindex="0">
        <img class="menuIcon" src="<!--{$lib_path}-->dynicons/?img=application-x-executable.svg&amp;w=96" style="position: relative" alt="Database Update" title="Database Update" />

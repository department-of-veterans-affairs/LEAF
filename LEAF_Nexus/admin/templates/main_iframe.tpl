...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        @import "{$app_js_app}/jquery/css/dcvamc/jquery-ui.custom.min.css";
        @import "{$app_js_app}/jquery/chosen/chosen.min.css";
        {/if}
...
{/section}
    ...
    {if $useDojo == true}
    <script type="text/javascript" src="{$app_js_app}/jquery/jquery.min.js"></script>
    {if $useDojoUI == true}<script type="text/javascript" src="{$app_js_app}/jquery/jquery-ui.custom.min.js"></script>{/if}
    {/if}

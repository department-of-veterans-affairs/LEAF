<div id="fileBrowser" style="float: left; width: 200px; margin: 4px">
    <button class="buttonNorm" onclick="newReport();" style="float: left; width: 200px; margin: 4px;"><img src="<!--{$libsPath}-->dynicons/?img=document-new.svg&w=32" alt="New File" /> New File</button><br />
    <b>Files:</b>
    <div id="fileList"></div>
</div>
...
<div id="controls" style="float: right; width: 170px; visibility: hidden">
    <div id="saveButton" class="buttonNorm" onclick="save();"><img id="saveIndicator" src="<!--{$libsPath}-->dynicons/?img=media-floppy.svg&w=32" alt="Save" /> Save Changes</div><br /><br /><br />
    <div class="buttonNorm" onclick="runReport();"><img id="saveIndicator" src="<!--{$libsPath}-->dynicons/?img=x-office-spreadsheet.svg&w=32" alt="Open Report" /> Open Report</div>
    <br /><br /><br /><br /><br /><br />
    <div id="deleteButton" class="buttonNorm" onclick="deleteReport();"><img src="<!--{$libsPath}-->dynicons/?img=process-stop.svg&w=32" alt="Delete Report" /> Delete Report</div>
</div>

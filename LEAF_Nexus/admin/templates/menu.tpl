    ...
    <div id="headerMenuHelp_container" style="display: inline-block">
        <a id="button_showHelp" tabindex="0" class="buttonNorm" alt="Help Popup"
            ...
            role="button"><img style="vertical-align: sub;" src="{$libsPath}dynicons/?img=help-browser.svg&amp;w=16">&nbsp;Help</a>
...
{if isset($isAdmin)}
    <a href="./" class="buttonNorm"><img src="{$libsPath}dynicons/?img=applications-system.svg&amp;w=16" alt="Admin Panel" title="Admin Panel" />OC Admin Panel</a>
{/if}
<br />

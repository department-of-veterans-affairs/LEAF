...
<form id="record" enctype="multipart/form-data" action="javascript:void(0);">
    <div>
        <span id="button_cancelchange" class="buttonNorm" style="position: absolute; left: 10px"><img src="../dynicons/?img=process-stop.svg&amp;w=16" alt="cancel" /> Cancel</span>
        <span id="button_save" class="buttonNorm" style="position: absolute; right: 10px"><img src="../dynicons/?img=media-floppy.svg&amp;w=16" alt="save" /> Save Change</span>

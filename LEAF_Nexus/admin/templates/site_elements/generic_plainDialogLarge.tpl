...
<form id="recordLarge" enctype="multipart/form-data" action="javascript:void(0);">
    <div>
        ...
        <div id="loadIndicatorplainLarge" style="visibility: hidden; position: absolute; text-align: center; font-size: 24px; font-weight: bold; background: white; padding: 16px; height: 200px; width: 460px">Loading... <img src="../images/largespinner.gif" alt="loading..." /></div>

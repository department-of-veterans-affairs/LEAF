...
<div class="button" onclick="hideConfirmation()" style="float: left; padding: 8px; text-align: center; width: 200px"><img src="../libs/dynicons/?img=process-stop.svg&amp;w=32" style="vertical-align: middle" alt="Icon" title="Icon" /> No</div>
<div class="button" onclick="confirmDelete()" style="float: left; padding: 8px; text-align: center; width: 200px"><img src="../libs/dynicons/?img=edit-delete.svg&amp;w=32" style="vertical-align: middle" alt="Icon" title="Icon" /> Yes</div>
</div>

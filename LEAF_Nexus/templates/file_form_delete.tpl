...
<div class="button" onclick="hideConfirmation()" style="float: left; padding: 8px; text-align: center; width: 200px"><img src="dynicons/?img=process-stop.svg&amp;w=32" style="vertical-align: middle" alt="" /> No</div>
<div class="button" onclick="confirmDelete()" style="float: left; padding: 8px; text-align: center; width: 200px"><img src="dynicons/?img=edit-delete.svg&amp;w=32" style="vertical-align: middle" alt="" /> Yes</div>
</div>

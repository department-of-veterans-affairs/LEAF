<div id="toolbar" class="toolbar_right toolbar noprint">
    <div id="tools"><h1>Options</h1>
        ...
        <div onclick="addGroup()"><img src="dynicons/?img=list-add.svg&amp;w=32" style="vertical-align: middle" alt="Add Group" title="Add Group" /> Add Group/Service</div>
        ...
        <div onclick="addOwner()"><img src="dynicons/?img=list-add.svg&amp;w=32" style="vertical-align: middle" alt="Add Owner" title="Add Owner" /> Add Owner</div>
    </div>
</div>

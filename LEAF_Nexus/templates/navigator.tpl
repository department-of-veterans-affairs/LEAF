...
<span id="editor_toolbar" class="noprint">
    <span id="editor_tools">
        <span onclick="window.location='?a=editor&amp;rootID=<!--{$rootID}-->';"><img src="<!--{$lib_path}-->dynicons/?img=accessories-text-editor.svg&amp;w=32" style="vertical-align: middle" alt="Edit" title="Edit" /> Edit Orgchart</span>
...
function getSubordinates(positionID, level) {
    ...
    for(var key in positions[positionID].data.subordinates) {
        ...
        positions[subordinate[key].positionID].onLoad = function() {
            ...
            positions[subordinate[key].positionID].addControl('<div class="button" onclick="window.location=\'?a=view_position&amp;positionID='+this.positionID+'\';"><img src="<!--{$lib_path}-->dynicons/?img=accessories-text-editor.svg&amp;w=32" alt="Edit" title="Edit" /> View Details</div>');
            positions[subordinate[key].positionID].addControl('<div class="button" onclick="window.location=\'?a=navigator&amp;rootID='+this.positionID+'\'"><img src="<!--{$lib_path}-->dynicons/?img=system-search.svg&amp;w=32" alt="Focus" title="Focus" /> Focus on This</div>');
...
$(function() {
    ...
    positions[<!--{$rootID}-->].addControl('<div class="button" onclick="window.location=\'?a=view_position&amp;positionID=<!--{$rootID}-->\';"><img src="<!--{$lib_path}-->dynicons/?img=accessories-text-editor.svg&amp;w=32" alt="Edit" title="Edit" /> View Details</div>');

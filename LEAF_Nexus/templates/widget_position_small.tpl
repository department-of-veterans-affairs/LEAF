<div class="positionSmall" onclick="selectPosition(<!--{$positionData['positionID']}-->)">
    <img class="positionPhoto" id="pPhoto_<!--{$positionData['positionID']|strip_tags|escape}-->" src="<!--{$lib_path}-->dynicons/?img=gnome-stock-person.svg&amp;w=64" alt="photo" title="photo" />

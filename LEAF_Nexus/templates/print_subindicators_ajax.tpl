<!--{**}-->
        ...
        <!--{if $indicator.format == 'fileupload'}-->
            ...
            <a href="file.php?categoryID=<!--{$categoryID|strip_tags|escape}-->&amp;UID=<!--{$uid|strip_tags|escape}-->&amp;indicatorID=<!--{$indicator.indicatorID|strip_tags|escape}-->&amp;file=<!--{$file|urlencode}-->" target="_blank" class="printResponse" onclick="event.stopPropagation();"><img src="<!--{$lib_path}-->dynicons/?img=mail-attachment.svg&amp;w=16" /><!--{$file|strip_tags|escape}--></a>
            <!--{/foreach}-->
            <!--{else}-->
            No files attached.
            <!--{/if}-->

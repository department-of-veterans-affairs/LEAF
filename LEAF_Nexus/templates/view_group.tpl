...
<div id="toolbar" class="toolbar_right toolbar noprint">
    <div id="tools"><h1 role="heading" tabindex="0">Options</h1>
        ...
        <div onkeypress="triggerClickViewOrgchart(event)" role="button" id="view_orgchart"><a id="view_orgchart_link" href="?a=navigator&amp;rootID=<!--{$groupLeader|sanitize}-->"></a><img src="<!--{$libsPath}-->dynicons/?img=preferences-system-windows.svg&amp;w=32" style="vertical-align: middle" alt="View Org Chart" title="View Org Chart" /> View in Org Chart</div>
        <br />
        <!--{/if}-->
        <button class="options" onclick="editGroupName()" style="width: 100%"><img src="<!--{$libsPath}-->dynicons/?img=edit-select-all.svg&amp;w=32" style="vertical-align: middle" alt="Edit" title="Edit" /> Edit Group Name</button>
        <button class="options" id="button_addEmployeePosition" onclick="addEmployeePosition()" style="width: 100%"><img src="<!--{$libsPath}-->dynicons/?img=list-add.svg&amp;w=32" style="vertical-align: middle" alt="Add Employee/" title="Add Employee/Position" /> Add Employee/Position</button>
        <button class="options" onclick="viewHistory()"><img src="<!--{$libsPath}-->dynicons/?img=appointment.svg&amp;w=32" alt="View Status" title="View History" style="vertical-align: middle"> View History</button>
        <br />
        <br />
        <button class="options" onclick="confirmRemove()" style="width: 100%"><img src="<!--{$libsPath}-->dynicons/?img=process-stop.svg&amp;w=16" style="vertical-align: middle" alt="Delete Position" title="Delete Position" /> Delete Group</div>
    </button>
...
<br />
    <div class="toolbar_security"><h1 role="heading" tabindex="0">Security Permissions</h1>
        ...
        <button class="buttonPermission"  style="width: 100%" onclick="window.open('index.php?a=view_group_permissions&amp;groupID=<!--{$groupID}-->','Orgchart','width=840,resizable=yes,scrollbars=yes,menubar=yes');">
            <img src="<!--{$libsPath}-->dynicons/?img=emblem-system.svg&amp;w=32" alt="Change Permissions" style="vertical-align: middle"/> Change Permissions
        </button>
        <!--{/if}-->
    </div>
</div>
...
function confirmRemove() {
	...
	<!--{/if}-->
    confirm_dialog.setContent('<img src="<!--{$libsPath}-->dynicons/?img=help-browser.svg&amp;w=48" alt="question icon" style="float: left; padding-right: 16px" /> <span style="font-size: 150%">Are you sure you want to delete this group?</span>' + warning);
...
function confirmUnlinkPosition(positionID) {
	confirm_dialog.setContent('<img src="<!--{$libsPath}-->dynicons/?img=help-browser.svg&amp;w=48" alt="question icon" style="float: left; padding-right: 16px" /> <span style="font-size: 150%">Are you sure you want to remove this position?</span>');
	confirm_dialog.setTitle('Confirmation');
	confirm_dialog.setSaveHandler(function() {
		$.ajax({
            type: 'DELETE',
...
function confirmUnlinkEmployee(empUID) {
    confirm_dialog.setContent('<img src="<!--{$libsPath}-->dynicons/?img=help-browser.svg&amp;w=48" alt="question icon" style="float: left; padding-right: 16px" /> <span style="font-size: 150%">Are you sure you want to remove this employee?</span>');
    confirm_dialog.setTitle('Confirmation');
    confirm_dialog.setSaveHandler(function() {
        $.ajax({
        	type: 'DELETE',
...
function confirmDeleteTag(inTag) {
    ...
    confirm_dialog.setContent('<img src="<!--{$libsPath}-->dynicons/?img=help-browser.svg&amp;w=48" alt="question icon" style="float: left; padding-right: 16px" /> <span style="font-size: 150%">Are you sure you want to delete this tag?</span>'+ warning);
    confirm_dialog.setTitle('Confirmation');
    confirm_dialog.setSaveHandler(function() {
        $.ajax({
        	type: 'DELETE',

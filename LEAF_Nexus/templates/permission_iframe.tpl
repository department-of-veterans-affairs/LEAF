...
<div style="padding: 4px; color: red">
    <img src="<!--{$libsPath}-->dynicons/?img=emblem-readonly.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />
    No access to read this field.
    <!--{else}-->
<div style="padding: 4px; color: green" tabindex="0">
    <img src="<!--{$libsPath}-->dynicons/?img=edit-find.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />
...
<div style="padding: 4px; color: red" tabindex="0">
    ...
    <!--{else}-->
<div style="padding: 4px; color: green" tabindex="0">
    <img src="<!--{$libsPath}-->dynicons/?img=accessories-text-editor.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />
...
<div style="padding: 4px; color: green">
    ...
    <img src="<!--{$libsPath}-->dynicons/?img=emblem-system.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />

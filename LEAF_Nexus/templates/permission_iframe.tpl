...
<div style="padding: 4px; color: red">
    <img src="dynicons/?img=emblem-readonly.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />
    No access to read this field.
    <!--{else}-->
<div style="padding: 4px; color: green" tabindex="0">
    <img src="dynicons/?img=edit-find.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />
...
<div style="padding: 4px; color: red" tabindex="0">
    ...
    <!--{else}-->
<div style="padding: 4px; color: green" tabindex="0">
    <img src="dynicons/?img=accessories-text-editor.svg&amp;w=32" alt="Icon" style="vertical-align: middle" />

    orgchartForm.addUpdateEvent(5, function(response) {
        ...
        dialog.setContent('<div style="border: 1px solid black; background-color: #e0e0e0"><div style="float: left; padding: 32px"><img src="dynicons/?img=system-lock-screen.svg&amp;w=72" alt="" /></div>\

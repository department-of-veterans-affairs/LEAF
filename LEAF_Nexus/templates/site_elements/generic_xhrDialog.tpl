...
<form id="record" enctype="multipart/form-data" action="javascript:void(0);">
    <div>
        <button id="button_cancelchange" class="buttonNorm" style="position: absolute; left: 10px"><img src="<!--{$libsPath}-->dynicons/?img=process-stop.svg&amp;w=16" alt="Cancel" title="Cancel" /> Cancel</button>
        <button id="button_save" class="buttonNorm" style="position: absolute; right: 10px"><img src="<!--{$libsPath}-->dynicons/?img=media-floppy.svg&amp;w=16" alt="Save Changes" title="Save Changes" /> Save Change</button>

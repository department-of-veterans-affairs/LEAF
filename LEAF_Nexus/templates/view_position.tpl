<div id="toolbar" class="toolbar_right toolbar noprint">
    <div id="tools"><h1>Tools</h1>
        <div onclick="window.location='?a=navigator&amp;rootID=<!--{$positionID|strip_tags}-->';"><img src="<!--{$lib_path}-->dynicons/?img=preferences-system-windows.svg&amp;w=32" style="vertical-align: middle" alt="Add Employee" title="Add Employee" /> View in Org Chart</div>
        <div onclick="addEmployee()"><img src="<!--{$lib_path}-->dynicons/?img=list-add.svg&amp;w=32" style="vertical-align: middle" alt="Add Employee" title="Add Employee" /> Add Employee</div>
        <div onclick="editTitle()"><img src="<!--{$lib_path}-->dynicons/?img=edit-select-all.svg&amp;w=32" style="vertical-align: middle" alt="Edit" title="Edit" /> Edit Title</div>
        <div onclick="changeSupervisor()"><img src="<!--{$lib_path}-->dynicons/?img=system-users.svg&amp;w=32" style="vertical-align: middle" alt="Change Service" title="Change Service" /> Change Supervisor</div>
        ...
        <br />
        <div onclick="confirmRemove()"><img src="<!--{$lib_path}-->dynicons/?img=process-stop.svg&amp;w=16" style="vertical-align: middle" alt="Delete Position" title="Delete Position" /> Delete Position</div>
    </div>
...
<br />
    <div class="toolbar_security"><h1>Security Permissions</h1>
        ...
        <!--{else}-->
            <img src="<!--{$lib_path}-->dynicons/?img=emblem-readonly.svg&amp;w=32" alt="No Read Access" style="vertical-align: middle" /> You do not have read access
        <!--{/if}-->
        </div>
        <div>
        <!--{if $positionPrivileges[$positionID].write == 1}-->
        ...
        <!--{if $positionSummary.employeeList[0].empUID != ''}-->
          ...
          <div id="employee_<!--{$counter}-->" class="employee">
              <div id="employeeHeader_<!--{$counter}-->" class="employeeHeader">
                  <img src="<!--{$lib_path}-->dynicons/?img=process-stop.svg&amp;w=16" style="float: right; cursor: pointer" onclick="confirmUnlink(<!--{$employee.empUID|strip_tags}-->); return false;" alt="Unlink Employee" title="Unlink Employee" />
          ...
          <!--{if $counter - $numActing < $positionSummary.positionData[19].data && $positionSummary.positionData[19].data != ''}-->
            <div class="employee">
                ...
                <div class="employeeBody">
                    <div class="button" onclick="startFTE()"><img src="<!--{$lib_path}-->dynicons/?img=document-new.svg&amp;w=32" style="vertical-align: middle" alt="Add Employee" title="Add Employee" /> Initiate FTE Request to fill Vacancy</div>
                </div>
            </div>
...
<form id="start_requestrecord" enctype="multipart/form-data" action="javascript:void(0);">
    <div>
        <span id="start_requestbutton_cancelchange" class="buttonNorm" style="position: absolute; left: 10px"><img src="<!--{$lib_path}-->dynicons/?img=process-stop.svg&amp;w=16" alt="cancel" /> Cancel</span>
        ...
        <div id="start_requestbutton_save" class="buttonNorm" style="width: 80%"><img src="<!--{$lib_path}-->dynicons/?img=go-next.svg&amp;w=32" alt="save" /> Start FTE Request to fill <b><!--{$positionSummary.employeeList[0].positionTitle|sanitize}--></b></div>
        <br /><br />
    </div>
</form>
</div>
...
function confirmUnlink(empUID) {
	confirm_dialog.setContent('<img src="<!--{$lib_path}-->dynicons/?img=help-browser.svg&amp;w=48" alt="question icon" style="float: left; padding-right: 16px" /> <span style="font-size: 150%">Are you sure you want to unlink this employee?</span>');

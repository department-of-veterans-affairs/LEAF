...
<a href="?a=navigator" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: #ffefa5" tabindex="0">
        <img class="menuIconSmall" src="<!--{$libsPath}-->dynicons/?img=applications-internet.svg&amp;w=76" style="position: relative" alt="Navigator" title="Navigator" />
...
<a href="?a=navigator&amp;rootID=<!--{$groupLeader|strip_tags}-->" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: #b3ceff" tabindex="0">
        <img class="menuIconSmall" src="<!--{$libsPath}-->dynicons/?img=preferences-system-windows.svg&amp;w=76" style="position: relative" alt="Search" title="Search" />
...
<a href="./utils/exportPDL.php" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: black" tabindex="0">
        <img class="menuIconSmall" src="<!--{$libsPath}-->dynicons/?img=x-office-spreadsheet.svg&amp;w=76" style="position: relative" alt="Bookmarks" title="Bookmarks" />
...
<a href="?a=summary" tabindex="-1">
    <span class="menuButtonSmall" style="background-color: black" tabindex="0">
        <img class="menuIconSmall" src="<!--{$libsPath}-->dynicons/?img=x-office-presentation.svg&amp;w=76" style="position: relative" alt="Bookmarks" title="Bookmarks" />
    ...
    <div id="searchContainer" style="float: left; border: 1px solid #e0e0e0; padding: 4px; background-color: white">
        ...
        <div id="searchTips" style="max-width: 300px">
            <fieldset><legend style="font-size: 11px; color: #767676">Available Search Options</legend>
               <div>
                   <img title="Employees" alt="Employees" style="float: left; padding: 8px" src="<!--{$libsPath}-->dynicons/?img=contact-new.svg&amp;w=32" />
                   <div><h3>Employees</h3>
                   Names</div>
               </div>
               <br />
               <div>
                   <img title="Positions" alt="Positions" style="float: left; padding: 8px" src="<!--{$libsPath}-->dynicons/?img=system-users.svg&amp;w=32" />
                   <div><h3>Positions</h3>
                   Titles, PD Number</div>
               </div>
               <br />
               <div>
                   <img title="Groups" alt="Groups" style="float: left; padding: 8px" src="<!--{$libsPath}-->dynicons/?img=preferences-desktop-theme.svg&amp;w=32" />
                   <div><h3>Groups</h3>

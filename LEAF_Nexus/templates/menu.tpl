{if $action != ''}
    <a href="./" class="buttonNorm"><img src="{$libsPath}dynicons/?img=go-home.svg&amp;w=16" alt="Main Page" title="Main Page" />Main Page</a>
{/if}
    <div id="headerMenuHelp_container" style="display: inline-block">
        <a id="button_showHelp" tabindex="0" class="buttonNorm" alt="Help Popup" title="Help" aria-haspopup="true" aria-expanded="false" role="button"><img style="vertical-align: sub;" src="{$libsPath}dynicons/?img=help-browser.svg&amp;w=16" alt=""/>&nbsp;Help</a>
...
{if isset($isAdmin)}
    <a href="./admin/" class="buttonNorm"><img src="{$libsPath}dynicons/?img=applications-system.svg&amp;w=16" alt="Admin Panel" title="Admin Panel" />OC Admin Panel</a>
{/if}
<br />

<form id="record" enctype="multipart/form-data" action="ajaxIndex.php?a=doupload&amp;categoryID={$categoryID}&amp;UID={$UID}" method="post">
    ...
    <div id="file{$categoryID}_{$UID}_{$indicatorID}_status" style="visibility: hidden; display: none; background-color: #fffcae; padding: 4px"><img src="images/indicator.gif" alt="loading..." /> Attaching file...</div>

...
nationalEmployeeSelector.prototype.initialize = function() {
	...
	$('#' + this.containerID).html('<div id="'+this.prefixID+'border" class="employeeSelectorBorder">\
			...
			<img id="'+this.prefixID+'iconBusy" src="'+ t.rootPath +'images/indicator.gif" style="display: none" class="employeeSelectorIcon" alt="search" />\
			<input id="'+this.prefixID+'input" type="search" class="employeeSelectorInput" style="width: calc(90% - 100px)"></input></div>\
...
nationalEmployeeSelector.prototype.search = function() {
	...
	if(this.timer > 300) {
	    ...
	    var domain = $('#' + this.prefixID + 'domain').val();
	    ...
	    if(txt != "" && txt != undefined && (txt != this.q || domain != this.qDomain)) {
	    	...
	    	var ajaxOptions = {
		            url: this.apiPath + "national/employee/search",
		            dataType: 'json',
			    	data: {q: this.q,

   ...
   */
    function writePortalConfig()
    {
        $portalConfig = array(
          ...
          'uploadDir' => array('varName' => 'uploadDir', 'varValue' => '', 'varComment' => 'Directory for user uploads. using backslashes (/), with trailing slash', 'varType' => 'static'),
          'leafSecure' => array('varName' => 'leafSecure', 'varValue' => '', 'varComment' => '', 'varType' => 'static'),
          'orgchartPath' => array('varName' => 'orgchartPath', 'varValue' => '', 'varComment' => 'HTTP Path to orgchart with no trailing slash', 'varType' => 'static'),
          'orgchartImportTags' => array('varName' => 'orgchartImportTags', 'varValue' => "", 'varComment' => 'Import org chart groups if they match these tags', 'varType' => 'static'),
          'descriptionID' => array('varName' => 'descriptionID', 'varValue' => '', 'varComment' => 'indicator ID for description field', 'varType' => ''),
          'emailPrefix' => array('varName' => 'emailPrefix', 'varValue' => '', 'varComment' => 'Email prefix', 'varType' => 'static'),
          'emailCC' => array('varName' => 'emailCC', 'varValue' => '', 'varComment' => 'CCed for every email', 'varType' => 'static'),
          'emailBCC' => array('varName' => 'emailBCC', 'varValue' => '', 'varComment' => 'BCCed for every email', 'varType' => 'static'),
    ...
    function writeNexusConfig()
    {
        $nexusConfig = array(
          ...
          'uploadDir' => array('varName' => 'uploadDir', 'varValue' => '', 'varComment' => 'Directory for user uploads. using backslashes (/), with trailing slash', 'varType' => 'static'),
          'ERM_Sites' => array('varName' => 'ERM_Sites', 'varValue' => "", 'varComment' => 'URL to ERM sites with trailing slash', 'varType' => 'static'),
